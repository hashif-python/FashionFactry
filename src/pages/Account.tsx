    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          <p className="text-xl text-gray-600 mb-4">Please login to view your account</p>
          <button
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full text-left px-4 py-3 border border-gray-300 rounded-lg hover:border-[#C8A962] hover:bg-gray-50 transition-colors"
              >
