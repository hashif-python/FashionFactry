  ...
  const loadProducts = async (gender: string) => {
    ...
    try {
      let base =
        gender === "all"
          ? `products/spectacles/`
          : `products/search/gender/?gender=${gender}&type=spectacle`;
      ...
      console.error("Error loading spectacles:", err);
      setProducts([]);
      setHasMore(false);
    } finally {
      setLoading(false);
  ...
  return (
    <div className="min-h-screen py-4 sm:py-8 text-white page-content relative">
      <div className="max-w-7xl mx-auto px-4 relative">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-6">Spectacles</h1>
